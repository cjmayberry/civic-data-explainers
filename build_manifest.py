...
CATEGORY_OVERRIDES = {
    ...
    # --- Missouri v4 12-category taxonomy (2026-08-11) ---
    "2rxb-22d7": ("Government", "Child-support enforcement offices."),
    "2zg8-cta8": ("Economy", "Farmers' market directory — agriculture/economy."),
    "38q6-ispi": ("Finance", "v4 fix: was Government"),
    "3dcz-79am": ("Health", "Certified home-health provider registry."),
    "3mwf-kse4": ("Environment", "v4 fix: was Parks & Recreation"),
    "3vxz-wrn6": ("Health", "Demographic/health stats for deaf & hard-of-hearing."),
    "4v5t-4kqk": ("Economy", "Unemployment claims/rates/benefits — labor market."),
    "4xqz-ug2j": ("Licensing", "Certified onsite soil evaluators."),
    "53ys-svak": ("Finance", "v4 fix: was Government"),
    "55pd-epiy": ("Finance", "v4 fix: was Government"),
    "5tqh-2x4m": ("Economy", "Unemployment claims/rates/benefits — labor market."),
    "667w-c6py": ("Health", "Health provider registry."),
    "6xq5-em5d": ("Health", "Emergency medical transport."),
    "7ac3-k2di": ("Licensing", "Licensed lodging establishments."),
    "83mm-j7ms": ("Government", "Public-sector job openings."),
    "8ejy-sj4q": ("Government", "ZIP-code geography."),
    "8gbc-na3a": ("Health", "Occupational/workplace injury statistics — health data."),
    "8hb2-5svi": ("Economy", "Workforce training program."),
    "8yaf-xv66": ("Education", "High-school senior counts."),
    "8zvy-7azn": ("Health", "Dept of Mental Health veterans provider enrollment."),
    "945m-hi5h": ("Environment", "Beach water-quality status."),
    "a7u4-7njw": ("Health", "Physical-therapy provider registry."),
    "b7cg-4kvc": ("Transportation", "Capitol parking map."),
    "bf4t-a367": ("Government", "Agency directory."),
    "bipa-db22": ("Finance", "v4 fix: was Government"),
    "byps-gsbw": ("Government", "v4 fix: was Parks & Recreation"),
    "cacd-xibb": ("Finance", "Energy-assistance benefit averages (city) — benefits funding."),
    "cj66-t7xq": ("Economy", "Unemployment claims/rates/benefits — labor market."),
    "cq57-7qrb": ("Economy", "Unemployment claims/rates/benefits — labor market."),
    "diyi-fr2a": ("Health", "WIC program data — maternal/child health."),
    "dsx5-5mwh": ("Government", "Social-services resource centers."),
    "e7p8-a69d": ("Health", "Emergency medical transport."),
    "eb3y-vtsa": ("Health", "Food-pantry/social-services network."),
    "fcza-fcn8": ("Finance", "Energy-assistance benefit averages (county) — benefits funding."),
    "fenu-sipv": ("Health", "Long-term-care provider directory."),
    "fk75-fa28": ("Health", "Communicable-disease surveillance."),
    "g5ud-am38": ("Health", "Occupational/workplace injury statistics — health data."),
    "ggf4-p68x": ("Licensing", "Backflow-testers registry."),
    "ghmj-sbt9": ("Health", "Pregnancy-assistance providers."),
    "grft-acku": ("Health", "Hospice provider registry."),
    "gwbj-nw4k": ("Health", "Certified home-health provider registry."),
    "hhyk-mgim": ("Infrastructure", "Building-code standards."),
    "hv22-kqak": ("Economy", "Unemployment claims/rates/benefits — labor market."),
    "im7g-fucq": ("Government", "ZIP-to-county geography."),
    "inpf-ekav": ("Licensing", "v4 fix: was Finance"),
    "iq7s-izvt": ("Infrastructure", "Building-code standards."),
    "iqy7-7sid": ("Health", "End-stage renal disease facilities — health."),
    "ishd-twt7": ("Health", "Excel (behavioral-health) centers."),
    "iwta-573n": ("Health", "Safe-haven baby box registration."),
    "kadm-zhzb": ("Health", "Occupational/workplace injury statistics — health data."),
    "kuz5-m96r": ("Economy", "Workforce assistance locations."),
    "kw9k-iwnn": ("Parks & Recreation", "State-park bison locations."),
    "m7kw-5852": ("Health", "COVID vaccination events."),
    "mcuk-295r": ("Health", "Occupational/workplace injury statistics — health data."),
    "mrdq-z2db": ("Licensing", "Certified home energy auditors."),
    "nc6i-4sv2": ("Economy", "Business incubator registry — economic development."),
    "nfxa-cq5r": ("Infrastructure", "Onsite wastewater treatment systems."),
    "p2ie-br32": ("Economy", "Employment/job-center locations."),
    "p7xr-4mcb": ("Health", "Occupational/workplace injury statistics — health data."),
    "ppia-3k9s": ("Licensing", "Licensed onsite system inspectors."),
    "qet9-8yam": ("Economy", "Unemployment claims/rates/benefits — labor market."),
    "qiy4-nwe9": ("Health", "Local public-health agency directory."),
    "qjj2-mrxw": ("Health", "Ambulatory surgery centers."),
    "qxbb-787k": ("Education", "Adult high-school excel center locations."),
    "r8ne-bg6j": ("Health", "Occupational/workplace injury statistics — health data."),
    "rtst-p7t3": ("Government", "County boundary geography."),
    "szw8-jbqy": ("Environment", "v4 fix: was Parks & Recreation"),
    "t9f4-ncza": ("Education", "Completed FAFSAs reported to MDHE."),
    "tvgd-f4ks": ("Health", "Occupational/workplace injury statistics — health data."),
    "uaxb-77vv": ("Economy", "Unemployment claims/rates/benefits — labor market."),
    "udnb-nqn3": ("Health", "COVID vaccination events."),
    "uite-mset": ("Economy", "Unemployment claims/rates/benefits — labor market."),
    "uqr3-yy6s": ("Government", "Regional geography."),
    "usf4-uuvb": ("Health", "Medical transport."),
    "v2fi-tjym": ("Health", "Occupational/workplace injury statistics — health data."),
    "w5xs-s3mj": ("Health", "Health-insurance navigators."),
    "w7h5-ge5s": ("Economy", "Local-business promotion."),
    "wbx5-smj6": ("Government", "Metropolitan/micropolitan geography stats."),
    "wh7n-cipb": ("Economy", "Retail-business directory."),
    "wkmi-4kdj": ("Health", "Prenatal health providers."),
    "wn56-7gv3": ("Government", "Community action agency contact info."),
    "x5wy-unx3": ("Government", "v4 fix: was Parks & Recreation"),
    "xm42-6a8n": ("Economy", "Unemployment claims/rates/benefits — labor market."),
    "xmt3-c8ve": ("Economy", "Employment/job-center locations."),
    "xudb-wnjq": ("Health", "Outpatient rehabilitation providers — health."),
    "y64b-aec2": ("Environment", "v4 fix: was Parks & Recreation"),
    "y83k-dbqp": ("Health", "Vaccines-for-Children (VFC) clinics."),
    "y84f-xfv7": ("Finance", "v4 fix: was Government"),
    "yeiz-h2m2": ("Infrastructure", "Utility locator."),
    "ymz7-guyk": ("Economy", "Labor-market quick facts."),
    # --- Tennessee v4 12-category taxonomy (2026-08-11) ---
    "active-statewide-childcare-locations-bfe29552": ("Education", "Childcare facility locations."),
    "ada-asset-data-69511fa7": ("Transportation", "ADA pedestrian assets."),
    "adopted-location-61cf8755": ("Transportation", "Adopt-a-highway adopted location."),
    "adopter-61cf8755": ("Transportation", "Adopt-a-highway adopter."),
    "boat-launch-sites-b3ab0451": ("Parks & Recreation", "Boat launch recreation access."),
    "bridge-condition-8d89d92e": ("Infrastructure", "Bridge condition (structure inventory)."),
    "bridge-condition-annual-8d89d92e": ("Infrastructure", "Bridge condition (structure inventory)."),
    "bridge-condition-annual-summary-8d89d92e": ("Infrastructure", "Bridge condition (structure inventory)."),
    "counties-f44bd806": ("Government", "County boundaries."),
    "crosswalks-69511fa7": ("Transportation", "Pedestrian crossings."),
    "curb-ramps-69511fa7": ("Transportation", "ADA curb ramps."),
    "find-a-park-points-data-filters-tn-state-parks-d54ec10b": ("Parks & Recreation", "State-park finder points."),
    "fish-attractor-locations-for-habitat-enhancement-ce62f590": ("Environment", "Fisheries habitat enhancement."),
    "fishing-sites-daf255dc": ("Parks & Recreation", "Fishing recreation sites."),
    "inform-fire-occurrence-data-record-fodr-de373a56": ("Public Safety", "Wildland fire occurrence."),
    "landscaping-and-flowers-1dd54a85": ("Infrastructure", "v4 fix: was Parks & Recreation"),
    "marina-sites-5fa96ee2": ("Parks & Recreation", "Marina sites."),
    "mowable-acres-129a15ac": ("Infrastructure", "v4 fix: was Parks & Recreation"),
    "naip-imagery-ndvi-6f6bcf8c": ("Environment", "Aerial imagery / NDVI land cover."),
    "national-register-of-historic-places-boundaries--ee21901a": ("Government", "National Register historic places."),
    "national-register-of-historic-places-points-tenn-0baa3ef7": ("Government", "National Register historic places."),
    "national-wetlands-inventory-b02ce30e": ("Environment", "National wetlands inventory."),
    "no-mow-19100c10": ("Infrastructure", "v4 fix: was Parks & Recreation"),
    "paddling-access-sites-2389307b": ("Parks & Recreation", "Paddling recreation access."),
    "pavement-roughness-annual-dca2dabf": ("Transportation", "Pavement roughness (road surface)."),
    "pavement-roughness-annual-summary-dca2dabf": ("Transportation", "Pavement roughness (road surface)."),
    "pavement-roughness-dca2dabf": ("Transportation", "Pavement roughness (road surface)."),
    "pedestrian-signal-69511fa7": ("Transportation", "Pedestrian signals."),
    "pickup-details-61cf8755": ("Transportation", "Adopt-a-highway pickup details."),
    "sgcnbycoa2025-089d5b8c": ("Environment", "Species of Greatest Conservation Need by county."),
    "sidewalks-69511fa7": ("Transportation", "Pedestrian sidewalks."),
    "soils-tennessee-f0e77996": ("Environment", "Soil survey data."),
    "specialty-pavement-markings-69511fa7": ("Transportation", "Pavement markings."),
    "specialty-pavement-markings-aff8d2f2": ("Transportation", "Pavement markings."),
    "state-aid-route-funding-6465d80a": ("Finance", "Road funding."),
    "tdec-huntable-areas-external-d33b97aa": ("Parks & Recreation", "Hunting recreation lands."),
    "tdot-adopt-a-highway-public-data-view-61cf8755": ("Transportation", "TDOT adopt-a-highway program."),
    "tdot-producer-list-plants-796303a7": ("Licensing", "TDOT certified plant producers."),
    "tennessee-conservation-opportunity-areas-and-spe-089d5b8c": ("Environment", "Conservation opportunity areas & species."),
    "tennessee-fire-danger-rating-areas-59255f5c": ("Public Safety", "Fire-danger rating areas."),
    "tennessee-forest-legacy-program-priority-areas-2-93cbc1eb": ("Environment", "Forest-conservation priority areas."),
    "tennessee-ng911-address-points-f76e2673": ("Public Safety", "NG911 emergency address/centerline infrastructure."),
    "tennessee-ng911-road-centerlines-1fc31033": ("Public Safety", "NG911 emergency address/centerline infrastructure."),
    "tennessee-polling-places-e47c3cff": ("Government", "Election polling places."),
    "tennessee-public-safety-answering-point-boundari-c8563776": ("Public Safety", "PSAP boundaries."),
    "tennessee-river-miles-and-county-boundaries-f44bd806": ("Government", "River miles + county boundaries."),
    "tennessee-state-forest-boundaries-cbae4ca7": ("Environment", "State-forest boundaries."),
    "tennessee-statewide-recreation-areas-public-f6c2e752": ("Parks & Recreation", "Statewide recreation areas."),
    "tennessee-statewide-trails-lines-public-49ef503e": ("Parks & Recreation", "Statewide trails."),
    "tennessee-statewide-trails-points-public-87d9ef12": ("Parks & Recreation", "Statewide trails."),
    "tennessee-wildfire-hazard-potential-hexagon-grid-d355ca53": ("Public Safety", "Wildfire hazard potential."),
    "tennessee-wildlife-management-area-entrances-5ed7fa43": ("Parks & Recreation", "Wildlife management area recreation access."),
    "tennessee-wildlife-resource-agency-region-bounda-e2d188a1": ("Parks & Recreation", "Wildlife agency region boundaries."),
    "tn-city-boundaries-cf079cf3": ("Government", "City boundaries."),
    "tn-coa25-089d5b8c": ("Environment", "Conservation opportunity areas."),
    "tn-congressional-districts-90e47429": ("Government", "Congressional districts."),
    "tn-historical-commission-sites-fa1485bb": ("Government", "Historical-commission sites."),
    "tn-house-districts-0d94ca77": ("Government", "State house districts."),
    "tn-rivermiles-f44bd806": ("Government", "River miles reference."),
    "tn-scenic-rivers-lines-4f61bcb9": ("Environment", "Scenic rivers."),
    "tn-senate-districts-977f2087": ("Government", "State senate districts."),
    "tn-state-parks-boundaries-1b28885b": ("Parks & Recreation", "State-park boundaries/points."),
    "tn-state-parks-points-d4ef7243": ("Parks & Recreation", "State-park boundaries/points."),
    "tnmap-data-server-access-c478c810": ("Environment", "Imagery/data server access."),
    "tnmap-imagery-webmercator-9ddbda7c": ("Environment", "Imagery basemap."),
    "traffic-lines-63b320c4": ("Transportation", "Road traffic striping."),
    "traffic-points-59838882": ("Transportation", "Road traffic points."),
    "trout-stocking-locations-in-tennessee-3ec5c58f": ("Parks & Recreation", "Trout-stocking recreation locations."),
    "twra-hunting-allowed-lands-e4fb1224": ("Parks & Recreation", "Hunting-allowed public lands."),
    "usfs-forest-legacy-completed-tracts-389c0319": ("Environment", "Forest-conservation priority areas."),
    "waterfowlblinds-25d32a1b": ("Parks & Recreation", "Waterfowl hunting blinds — recreation."),
    "wildland-fire-incident-locations-0750acfb": ("Public Safety", "Wildland fire incidents."),
    "winter-storm-fern-damage-assessment-840bd4a6": ("Public Safety", "Storm damage assessment."),
    # --- Kansas v4 12-category taxonomy (2026-08-11, fresh-state map) ---
    # Aquifers / lakes / watersheds / soils / USGS topos — natural systems → Environment
    "303-d-approved-590c7df6": ("Environment", "Clean Water Act 303(d) impaired-waters list — water quality; per v4 Environment."),
    "aquifer-extents-7684344e": ("Environment", "Aquifer extent footprint — natural hydrogeology; per v4 Environment (waterbodies)."),
    "cheney-lake-extent-c21223c5": ("Environment", "Lake extent — natural water body; per v4 Environment."),
    "dakota-aquifer-1a94d026": ("Environment", "Dakota Aquifer — natural hydrogeology; per v4 Environment."),
    "dakota-aquifer-base-1a94d026": ("Environment", "Dakota Aquifer base — natural hydrogeology; per v4 Environment."),
    "dakota-aquifer-top-1a94d026": ("Environment", "Dakota Aquifer top — natural hydrogeology; per v4 Environment."),
    "earthquakes-bbc487a3": ("Public Safety", "Earthquake events — natural-hazard monitoring; per v4 Public Safety (hazard, like TN storm damage)."),
    "huc-10-boundaries-99fc78f9": ("Environment", "HUC-10 watershed boundaries — natural hydrology; per v4 Environment."),
    "huc-12-boundaries-7cb40e88": ("Environment", "HUC-12 watershed boundaries — natural hydrology; per v4 Environment."),
    "huc-8-boundaries-66acd95e": ("Environment", "HUC-8 watershed boundaries — natural hydrology; per v4 Environment."),
    "high-plains-aquifer-c5972ca2": ("Environment", "High Plains Aquifer — natural hydrogeology; per v4 Environment."),
    "inorganic-organic-70e174de": ("Environment", "Inorganic/organic environmental monitoring — per v4 Environment (water/soil quality)."),
    "kansas-arboretums-c1b15431": ("Parks & Recreation", "Kansas arboretums — botanical gardens/parks; per v4 Parks & Recreation."),
    "kansas-sawmills-25f70b7a": ("Economy", "Kansas sawmills — forest-products industry; per v4 Economy."),
    "kansas-tree-cities-308e8696": ("Parks & Recreation", "Tree Cities — urban forestry program; per v4 Parks & Recreation."),
    "kdhe-reported-spills-32867c63": ("Environment", "KDHE reported spills — environmental contamination monitoring; per v4 Environment."),
    "kdhe-tmdl-lake-53575704": ("Environment", "KDHE TMDL lake — water-quality standard; per v4 Environment."),
    "kdhe-tmdl-stream-910998e2": ("Environment", "KDHE TMDL stream — water-quality standard; per v4 Environment."),
    "marion-lake-extent-4f44952f": ("Environment", "Marion Lake extent — natural water body; per v4 Environment."),
    "melvern-lake-extent-97d48513": ("Environment", "Melvern Lake extent — natural water body; per v4 Environment."),
    "milford-lake-extent-c0143643": ("Environment", "Milford Lake extent — natural water body; per v4 Environment."),
    "oil-and-gas-leases-66970100": ("Economy", "Oil & gas lease data — energy-sector economic activity; per v4 Economy."),
    "osage-aquifer-extent-7684344e": ("Environment", "Osage Aquifer extent — natural hydrogeology; per v4 Environment."),
    "ozark-aquifer-58374a14": ("Environment", "Ozark Aquifer — natural hydrogeology; per v4 Environment."),
    "ozark-aquifer-base-58374a14": ("Environment", "Ozark Aquifer base — natural hydrogeology; per v4 Environment."),
    "ozark-aquifer-extent-58374a14": ("Environment", "Ozark Aquifer extent — natural hydrogeology; per v4 Environment."),
    "ozark-aquifer-extent-7684344e": ("Environment", "Ozark Aquifer extent — natural hydrogeology; per v4 Environment."),
    "ozark-aquifer-top-58374a14": ("Environment", "Ozark Aquifer top — natural hydrogeology; per v4 Environment."),
    "perry-lake-extent-d8c3d835": ("Environment", "Perry Lake extent — natural water body; per v4 Environment."),
    "radiological-70e174de": ("Environment", "Radiological environmental monitoring — per v4 Environment."),
    "reported-wildfires-7c192b1e": ("Public Safety", "Reported wildfires — wildland fire incidents; per v4 Public Safety (MO/TN pattern)."),
    "soils-e3cc9752": ("Environment", "Soil survey data — per v4 Environment (Missouri clustered soils → Environment)."),
    "tmdl-590c7df6": ("Environment", "TMDL (water-quality standard) — per v4 Environment."),
    "tmdl-lake-590c7df6": ("Environment", "TMDL lake — water-quality standard; per v4 Environment."),
    "tmdl-stream-590c7df6": ("Environment", "TMDL stream — water-quality standard; per v4 Environment."),
    "type-wells-7889d5d3": ("Economy", "Type wells — oil-field well classification; per v4 Economy (energy sector)."),
    "usgs-scanned-topos-6299533e": ("Environment", "USGS scanned topographic maps — natural/carto; per v4 Environment."),
    "volatiles-organics-70e174de": ("Environment", "Volatiles/organics environmental monitoring — per v4 Environment."),
